...
import ProductsCardV from "./ProductsCardV";
      ...
      <div className="">
        ...
        <div className="bg-white py-40">
          <div className="p-4 lg:px-14 lg:py-4 max-w-screen-2xl mx-auto">
            <div className="flex flex-col w-full lg:w-1/2 mx-auto mb-12">
              <h2 className="my-3 font-bold text-3xl">{Json.section3.title}</h2>
              <p>{Json.section3.description}</p>
            </div>
            <div className="flex flex-col lg:flex-row my-5 items-center">
              ...
              <div className="w-full lg:w-1/2">
                <Image
                  src={Json.section3?.thumbnail}
                  width="auto"
                  height="auto"
                  alt={Json.section3?.title}
                />
              </div>
              <div className="w-full lg:w-1/4">
                {products &&
        ...
        <div className="bg-slate-100 py-40">
          <div className="max-w-screen-2xl mx-auto">
            <CardAbout
              title={Json.section4.title}
              description={Json.section4.description}
              srcBanner={Json.section4.thumbnail}
              icon={Json.section4.data}
            />
          </div>
        </div>
        ...
        <div className="py-40 bg-white">
          <div className="max-w-screen-2xl mx-auto">
            <div className="flex flex-col p-4 lg:px-14 lg:py-4">
              <h2 className="font-bold text-3xl my-3">{Json.section5.title}</h2>
              <p className="my-3">{Json.section5.description}</p>

              <div className="grid grid-cols-1 lg:grid-cols-3 my-5">
                {productsLoad &&
                  productsLoad?.map((v, i) => {
                    return (
                      <ProductsCardV 
              ...
              <button
                ...
                className="px-4 py-2 flex items-center justify-center bg-red-500 w-40 mx-auto text-white"
              >
                <svg
                  aria-hidden="true"
                  className="hidden mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-red-600"
                  viewBox="0 0 100 101"
                  fill="none"
          ...
          <div className="max-w-screen-2xl mx-auto flex flex-col md:flex-row p-4 items-center text-white lg:px-14 lg:py-4">
            ...
            <div className="w-full lg:w-5/12 flex flex-col items-center my-20 lg:my-4">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.solindo.ibisnis">
                <Image
                  imgClass={"w-60"}
                  src={"/src/assets/images/download-ibisnis.png"}
                  width="auto"
                  height="auto"
                />
              </a>
        ...
        <div className={`bg-white py-40 bg-[url('${Json.section7.thumbnail}')]`}>
          <div className="p-4 lg:px-14 lg:py-4">
            <h2 className="text-3xl font-bold my-5">Testimonial</h2>
            <SimpleSlider DataSlider={Json.section7.data} />
          </div>
        </div>
        ...
        <div className="py-40 bg-white">
          <div className="p-4 lg:px-14 lg:py-4 max-w-screen-2xl mx-auto">
            ...
            <button
              onClick={() =>
                setPostsLoad(fetchDataPosts(false, setPostsLoad, true))
              }
              className="px-4 py-2 flex items-center justify-center bg-red-500 w-40 mx-auto text-white"
            >
              <svg
